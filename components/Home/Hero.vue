      ...
      <div class="max-w-2xl mx-auto lg:max-w-5xl">
        <div class="max-w-2xl">
          <div class="w-full mb-8">
            <a aria-label="Home" class="block w-16 h-16 origin-left pointer-events-auto" href="/">
              <img alt="" sizes="4rem" src="~/assets/avatar.png" class="object-cover rounded-full h-18">
            </a>
          </div>
          ...
          <div class="flex gap-6 mt-6">
            ...
            <a class="p-1 -m-1 group" aria-label="Follow on Instagram" href="https://instagram.com">
              <svg viewBox="0 0 24 24" aria-hidden="true"
                class="w-6 h-6 transition fill-zinc-400 group-hover:fill-zinc-300">
                <path
            ...
            <a class="p-1 -m-1 group" aria-label="Follow on LinkedIn" href="https://linkedin.com/in/nadegehellemans/">
              <svg viewBox="0 0 24 24" aria-hidden="true"
                class="w-6 h-6 transition fill-zinc-400 group-hover:fill-zinc-300">
                <path
